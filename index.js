...
let record = createEmployeeRecord(["Julius", "Caesar", "General", 27]);
// Earns 324
record = createTimeInEvent(record, "0044-03-14 0900");
record = createTimeOutEvent(record, "0044-03-14 2100");
// Earns 54
record = createTimeInEvent(record, "0044-03-15 0900");
record = createTimeOutEvent(record, "0044-03-15 1100");
allWagesFor(record);
